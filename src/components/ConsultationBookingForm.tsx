...
const consultationTypes = [
    { id: 'initial', name: 'Initial Wellness Consultation', price: 150, duration: 60 },
    { id: 'follow-up', name: 'Follow-up Session', price: 85, duration: 30 },
    { id: 'intensive', name: 'Extended Wellness Session', price: 250, duration: 90 },
]
...
export default function ConsultationBookingForm({ defaultType }: Props) {
    ...
    if (success) {
        return (
            <div className="text-center py-16">
                ...
                <h3 className="text-3xl font-serif font-bold text-stone-50 mb-4">Request Received</h3>
                <p className="text-stone-400 font-light max-w-md mx-auto leading-relaxed">
                    Thanks — your consultation request is in. We&apos;ve sent a confirmation to <strong className="text-stone-300">{email}</strong> and our herbalists will confirm your slot within 24 hours.
                </p>
            </div>
        )
    }
    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                    <label className="text-[10px] text-amber-500 font-black uppercase tracking-widest ml-1">Session Type</label>
                    <select
                        value={type}
            ...
            <div className="space-y-3">
                <label className="text-[10px] text-amber-500 font-black uppercase tracking-widest ml-1">What would you like to focus on?</label>
                <textarea
                    value={objectives}
                    ...
                    placeholder="Tell us a little about your wellness goals and what you'd like to chat about…"
                />
            </div>
            ...
            <div className="organic-glass p-8 rounded-2xl border-stone-800 flex flex-col md:flex-row items-center gap-6 justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <p className="text-sm text-stone-400 max-w-xs leading-relaxed">
                        Sessions are held over a secure video link. We&apos;ll confirm your slot and payment details within 24 hours.
                    </p>
                </div>
                <button
                    type="submit"
                ...
                >
                    {loading ? <><Loader2 className="w-5 h-5 animate-spin" /> Sending…</> : 'Request Consultation'}
                </button>
            </div>
        </form>
    )
