...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(
    ({ className, variant = 'primary', size = 'md', children, ...props }, ref) => {
        ...
        const variants = {
            primary: 'bg-primary-900 text-secondary-400 shadow-[0_10px_20px_-5px_rgba(212,175,55,0.25)] hover:shadow-[0_20px_40px_-10px_rgba(212,175,55,0.4)] hover:bg-primary-800',
