...
export class AIContentService {
  ...
  static async generatePack(
    topic: string,
    persona: 'ALCHEMIST' | 'HERBALIST' | 'CLINICAL_LENS'
    ...
    const mockContent: Record<string, GeneratedContent> = {
      'Sea Moss': {
        ...
        excerpt:
          'Understanding the 92 minerals through the lens of cellular regeneration and alkaline harmony.',
...
From an alchemical perspective, sea moss represents the union of Earth and Water, synthesized in the depth of the ocean to provide the physical vessel with the requisite building blocks for repair. In this article, we explore how its mucilaginous properties support the gut-brain axis and 왜 (why) alkaline mineral density is the primary gatekeeper of human longevity.`,
        ...
        socials: {
          instagram:
            '🌊 Dive deep into the bio-chemistry of Sea Moss. 92 minerals. One source. #AlkaLibre #HECTIC',
          twitter:
            'Sea Moss is a bio-electrical storehouse. Learn why your thyroid needs this ocean gold. #SeaMoss #Wellness',
          linkedin:
            'The industrialization of wellness begins with mineral density. Analyzing the ROI of Sea Moss on human performance.',
        },
      },
    };
