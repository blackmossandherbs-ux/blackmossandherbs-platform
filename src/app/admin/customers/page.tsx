      ...
      <div className="container relative z-10">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
          <div>
            ...
            <p className="text-earth-400 text-lg">
              Verified Customer Database & interaction history
            </p>
          </div>
          <div className="flex bg-earth-900/50 p-1.5 rounded-2xl border border-earth-800 backdrop-blur-md">
            <button className="px-6 py-2.5 rounded-xl bg-primary-600 text-white font-bold text-xs uppercase tracking-widest transition-all shadow-lg shadow-primary-900/20">
              All Members
            </button>
            <button className="px-6 py-2.5 rounded-xl text-earth-500 font-bold text-xs uppercase tracking-widest hover:text-earth-300 transition-all">
              VIP Authority
            </button>
            <button className="px-6 py-2.5 rounded-xl text-earth-500 font-bold text-xs uppercase tracking-widest hover:text-earth-300 transition-all">
              Trialists
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              <thead className="bg-earth-950/80 border-b border-earth-800">
                <tr>
                  <th className="px-8 py-6 text-[10px] font-black text-earth-500 uppercase tracking-[0.2em]">
                    Authentic Entity
                  </th>
                  <th className="px-8 py-6 text-[10px] font-black text-earth-500 uppercase tracking-[0.2em]">
                    Rank
                  ...
                  <tr key={customer.id} className="hover:bg-earth-800/20 transition-colors group">
                    <td className="px-8 py-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="font-bold text-white group-hover:text-secondary-400 transition-colors">
                            {customer.name}
                          </div>
                    ...
                    <td className="px-8 py-6">
                      <div className="text-sm font-black text-secondary-400">
                        £{customer.spent.toFixed(2)}
                      </div>
                    </td>
                    <td className="px-8 py-6">
                      <div className="text-sm text-earth-400 font-medium">
                        {customer.lastActive}
                      </div>
                    </td>
        ...
        <div className="mt-10 flex items-center justify-between">
          <p className="text-sm text-earth-500 font-medium tracking-wide">
            Synchronized <span className="text-white font-bold">1-4</span> of{' '}
            <span className="text-secondary-400 font-bold">1,234</span> organic entities
          </p>
          <div className="flex gap-4">
            <button
              className="px-6 py-2.5 bg-earth-900/50 border border-earth-800 rounded-xl text-earth-500 font-bold text-xs uppercase tracking-widest hover:bg-earth-800 transition-all disabled:opacity-20"
              disabled
            >
              Previous
            </button>
            <button className="px-8 py-2.5 bg-earth-900 border border-earth-700 rounded-xl text-white font-bold text-xs uppercase tracking-widest hover:bg-earth-800 transition-all">
              Next Pulse
            </button>
          </div>
        </div>
