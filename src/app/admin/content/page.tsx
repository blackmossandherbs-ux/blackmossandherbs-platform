  ...
  const handleGenerate = async () => {
    ...
    setTimeout(() => {
      setDraft({
        title:
          topic === 'Sea Moss'
            ? 'The Alchemical Bio-Chemistry of Sea Moss'
            : `Autonomous Insights: ${topic}`,
          ...
          <div className="lg:col-span-1 space-y-6">
            <div className="card p-8 border border-earth-800 bg-earth-900/40 backdrop-blur-xl">
              ...
              <div className="space-y-6">
                <div>
                  <label className="block text-xs font-bold text-earth-500 uppercase tracking-widest mb-3">
                    Target Topic
                  </label>
                  <input
                    type="text"
            ...
            <div className="card p-8 border border-earth-800 bg-secondary-900/5 backdrop-blur-xl relative overflow-hidden">
              ...
              <p className="text-sm text-earth-400 mb-6 font-medium">
                Auto-dispatch current draft to the HECTIC ecosystem:
              </p>
          ...
          <div className="lg:col-span-2">
            {draft ? (
                ...
                <div className="card border border-earth-800 bg-earth-900/60 backdrop-blur-xl p-10">
                  ...
                  <div className="mt-12 grid grid-cols-2 gap-6">
                    <div className="p-6 bg-earth-900/50 border border-earth-800 rounded-2xl">
                      <h4 className="font-black text-[10px] mb-4 uppercase text-earth-500 tracking-[0.2em]">
                        Instagram Dispersion
                      </h4>
                      <p className="text-sm italic text-earth-300 font-medium leading-relaxed">
                        &quot;{draft.socials.instagram}&quot;
                      </p>
                    </div>
                    <div className="p-6 bg-earth-900/50 border border-earth-800 rounded-2xl">
                      <h4 className="font-black text-[10px] mb-4 uppercase text-earth-500 tracking-[0.2em]">
                        X (Twitter) Dispersion
                      </h4>
                      <p className="text-sm italic text-earth-300 font-medium leading-relaxed">
                        &quot;{draft.socials.twitter}&quot;
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="card h-full flex flex-col items-center justify-center p-20 text-center border-dashed border-2 border-earth-800/50 bg-earth-900/20 rounded-[3rem]">
                ...
                <h3 className="text-3xl font-serif font-bold text-earth-300 mb-4">
                  Command Post Dormant
                </h3>
                <p className="text-earth-500 text-lg max-w-sm mx-auto font-medium">
                  Provide a topic core to initiate the autonomous HECTIC content production cycle.
                </p>
              </div>
            )}
          </div>
