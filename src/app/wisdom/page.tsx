      ...
      <div className="container relative z-10">
        <div className="max-w-4xl mx-auto mb-20 text-center">
          ...
          <p className="text-xl text-stone-400 max-w-2xl mx-auto leading-relaxed font-light italic">
            &quot;Respecting the elders, verifying through science. We deal in organic
            reality.&quot;
          </p>
        </div>

        <div
          className={`transition-all duration-1000 ${!hasAccess ? 'blur-2xl pointer-events-none select-none grayscale opacity-30 scale-95' : ''}`}
        >
          {/* Wisdom categories */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
            {[
              ...
              <div
                key={idx}
                className={`organic-glass p-10 rounded-3xl group border-stone-800/10 hover:border-green-500/30 transition-all duration-700 cursor-pointer`}
              >
                ...
                <div className="flex items-center justify-between mt-auto">
                  ...
                  <span className="text-stone-500 group-hover:text-stone-100 transition-colors text-xs font-bold uppercase tracking-widest">
                    Verify →
                  </span>
                </div>
              </div>
          ...
          <div className="space-y-16">
            <div className="flex items-center gap-6 mb-12">
              <h2 className="text-4xl font-serif font-bold text-stone-50 tracking-tighter">
                Latest Realities.
              </h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
                ...
                <div className="h-full w-full rounded-[2rem] overflow-hidden relative">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-stone-950 via-stone-950/40 to-transparent flex flex-col justify-end p-12">
                    <div className="flex items-center gap-4 mb-6">
                      <span className="px-3 py-1 bg-amber-600 text-stone-950 text-[10px] font-black uppercase tracking-widest rounded-full">
                        Primary Insight
                      </span>
                      <span className="text-stone-400 text-xs font-bold tracking-widest">
                        12:45 MINS
                      </span>
                    </div>
                    <h3 className="text-4xl md:text-5xl font-serif font-bold text-stone-50 mb-4 leading-[0.9]">
                      The Biological <br />
                      Reality of Sea Moss.
                    </h3>
              ...
              <div className="space-y-6">
                {[
                  {
                    title: 'Iron Force: Why Salts aren&apos;t Iron',
                    date: 'Jan 04, 2026',
                    type: 'Biological',
                  },
                  {
                    title: 'Batana Oil: Cellular Follicle Repair',
                    date: 'Jan 02, 2026',
                    type: 'Botanical',
                  },
                  {
                    title: 'The Acidic Myth vs Cellular Reality',
                    date: 'Dec 28, 2025',
                    type: 'Scientific',
                  },
                ].map((article, idx) => (
                  <div
                    key={idx}
                    className="organic-glass p-8 rounded-3xl group cursor-pointer border-transparent hover:border-amber-500/20 transition-all duration-700 flex gap-8 items-center"
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <h4 className="text-2xl font-serif font-bold text-stone-100 group-hover:text-amber-500 transition-colors mb-2 leading-tight">
                        {article.title}
                      </h4>
          ...
          <div className="absolute inset-0 flex items-center justify-center z-20 px-4">
            <div className="max-w-xl w-full organic-glass p-16 md:p-24 rounded-[4rem] text-center border-amber-500/20 shadow-[0_40px_100px_rgba(0,0,0,0.8)] relative overflow-hidden group">
              ...
              <div className="relative z-10">
                ...
                <h1 className="text-4xl md:text-5xl font-serif font-bold text-stone-50 mb-6 leading-tight">
                  Wisdom is Earned.
                </h1>
                <p className="text-lg text-stone-400 mb-12 italic leading-relaxed font-light">
                  &quot;Access to biological truth is reserved for the committed. Join the Alchemist
                  Circle to unlock the full library.&quot;
                </p>
                <div className="flex flex-col gap-6">
                  ...
                  <p className="text-stone-500 text-[10px] font-black uppercase tracking-widest">
                    ...
                    <Link
                      href="/login"
                      className="text-amber-500 hover:text-white transition-colors ml-2 underline underline-offset-4"
                    >
                      Identify Self
                    </Link>
                  </p>
