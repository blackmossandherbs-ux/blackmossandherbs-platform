...
export const metadata: Metadata = {
  ...
  description:
    'Educational videos about herbal wellness, product tutorials, and expert interviews.',
};
...
const videos = [
  {
    ...
    description:
      'Learn the best ways to incorporate sea moss gel into your daily routine for maximum benefits.',
    category: 'Tutorials',
  ...
  },
  {
    ...
    description:
      'Discover how adaptogenic herbs work in your body to combat stress and promote balance.',
    category: 'Education',
    duration: 720,
    views: 8300,
  },
              ...
              <div className="card mb-12 overflow-hidden group hover:scale-[1.02] transition-transform">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  <div className="p-8 lg:p-12 flex flex-col justify-center">
                    ...
                    <p className="text-earth-600 text-lg mb-6">{video.description}</p>
              ...
              <Link key={video.id} href={`/videos/${video.slug}`}>
                <div className="card group overflow-hidden">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-earth-600 text-sm mb-4 line-clamp-2">{video.description}</p>
