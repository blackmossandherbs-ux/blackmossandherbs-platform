      ...
      <div className="container relative z-10">
        ...
        <div className="max-w-4xl mx-auto mb-24 text-center">
          ...
          <p className="text-xl text-stone-400 max-w-2xl mx-auto leading-relaxed font-light">
            Personalized alkaline protocols with master practitioners. Verify your biological
            restoration path with experienced herbal authority.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-24">
          {consultationTypes.map((type) => (
            <div
              key={type.id}
              className="organic-glass p-10 rounded-3xl border-transparent hover:border-green-500/30 transition-all duration-700 group"
            >
              ...
              <Button className="w-full h-14 group-hover:bg-amber-600 group-hover:text-stone-950 transition-all duration-700">
                Book Session
              </Button>
            </div>
          ))}
          ...
          <div className="organic-glass p-12 md:p-20 rounded-[3rem] border-amber-500/10">
            <div className="text-center mb-16">
              ...
              <p className="text-stone-400 font-light">
                Enter the alchemist&apos;s intake system below.
              </p>
            </div>
            ...
            <form className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-3">
                  <label className="text-[10px] text-amber-500 font-black uppercase tracking-widest ml-1">
                    Full Name
                  </label>
                  <input
                    type="text"
              ...
              <div className="organic-glass p-8 rounded-2xl border-stone-800 flex flex-col md:flex-row items-center gap-6 justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <p className="text-sm text-stone-400 max-w-xs leading-relaxed">
                    Consultations are high-frequency video sessions. You will receive a secure
                    meeting link upon verification.
                  </p>
                </div>
        ...
        <div className="mt-40">
          <div className="text-center mb-20">
            <h2 className="text-stone-500 text-[10px] font-black uppercase tracking-[0.4em] mb-4">
              Master Authority
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <div
                key={index}
                className="organic-glass p-10 text-center rounded-3xl border-stone-800/10 group hover:border-amber-500/20 transition-all duration-700"
              >
