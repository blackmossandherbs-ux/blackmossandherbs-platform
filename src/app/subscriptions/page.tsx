...
export const metadata: Metadata = {
  ...
  description:
    'Subscribe and save on your favorite herbal products. Get monthly deliveries and exclusive member benefits.',
};
            ...
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <span className="badge-primary px-6 py-2 text-sm font-bold">Most Popular</span>
                </div>
              )}

              <div className="p-8">
                <h3 className="font-serif text-2xl font-bold text-earth-900 mb-2">{plan.name}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={item.step} className="text-center">
                ...
                <h3 className="font-serif text-xl font-bold text-earth-900 mb-2">{item.title}</h3>
