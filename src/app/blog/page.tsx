...
const posts = [
  {
    ...
    excerpt:
      'Discover the incredible health benefits of sea moss and how to incorporate it into your daily routine for optimal wellness.',
    category: 'Superfoods',
  ...
  },
  {
    ...
    excerpt:
      'Learn about powerful herbs that can help strengthen your immune system naturally and keep you healthy year-round.',
  ...
  },
  {
    ...
    excerpt:
      "Explore how adaptogenic herbs can help your body manage stress and maintain balance in today's fast-paced world.",
    category: 'Wellness',
  ...
  },
  {
    ...
    excerpt:
      'Discover calming herbal tea combinations that can help you achieve deeper, more restful sleep naturally.',
  ...
  },
  {
    ...
    excerpt:
      'Uncover the anti-inflammatory properties of turmeric and creative ways to add it to your diet.',
    category: 'Nutrition',
  ...
  },
  {
    ...
    excerpt:
      "A beginner's guide to creating your own collection of essential herbs and natural remedies at home.",
              ...
              <article className="card mb-12 overflow-hidden group hover:scale-[1.02] transition-transform">
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  ...
                  <div className="p-8 lg:p-12 flex flex-col justify-center">
                    ...
                    <p className="text-earth-600 text-lg mb-6">{post.excerpt}</p>
              ...
              <Link key={post.id} href={`/blog/${post.slug}`}>
                <article className="card group h-full">
                  ...
                  <div className="p-6">
                    ...
                    <p className="text-earth-600 text-sm mb-4 line-clamp-3">{post.excerpt}</p>
