...
const getProduct = (slug: string) => {
  const products: Record<string, any> = {
    'sea-moss-gold-gel': {
      ...
      description:
        'Premium wildcrafted sea moss gel packed with 92 of the 102 minerals your body needs. Supports immune function, digestion, and overall wellness.',
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <div className="grid grid-cols-4 gap-4">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="card overflow-hidden cursor-pointer hover:ring-2 hover:ring-primary-500 transition-all"
                >
          ...
          <div>
            <div className="mb-4">
              ...
              {discount > 0 && (
                <span className="badge bg-red-100 text-red-800 ml-2">Save {discount}%</span>
              )}
            </div>
            ...
            <p className="text-earth-700 text-lg mb-8 leading-relaxed">{product.description}</p>
            ...
            <div className="card p-6 mb-6">
              <h3 className="font-serif text-xl font-bold text-earth-900 mb-4">Key Benefits</h3>
