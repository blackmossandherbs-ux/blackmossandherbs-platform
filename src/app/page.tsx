          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="max-w-xl">
              ...
              <p className="text-lg text-stone-300 mb-8">
                Wildcrafted sea moss and traditional herbs sourced directly from nature. Experience
                the benefits of Dr. Sebi-inspired alkaline nutrition.
              </p>
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-white border border-stone-200 rounded-lg p-6 text-center hover:border-green-500 transition-colors"
              >
        ...
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[1, 2, 3, 4].map((item) => (
              <div
                key={item}
                className="bg-white border border-stone-200 rounded-lg overflow-hidden hover:border-green-500 transition-colors"
              >
      ...
      <section className="py-20 bg-green-600 text-white">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-4xl md:text-5xl font-serif font-bold mb-6">Subscribe & Save 20%</h2>
            <p className="text-xl mb-8 text-green-50">
              Get your favorite herbal products delivered monthly and enjoy exclusive member
              benefits
            </p>
        ...
        <div className="container">
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <p className="section-subtitle">Expert tips and herbal wisdom from our blog</p>
            </div>
            <Link href="/blog">
              <Button variant="outline">
                Read More
              ...
              <article key={item} className="card group">
                ...
                <div className="p-6">
                  ...
                  <p className="text-earth-600 text-sm mb-4">
                    Discover how incorporating herbal remedies into your daily routine can transform
                    your health...
                  </p>
                  <Link
                    href={`/blog/post-${item}`}
      ...
      <section className="py-20 bg-earth-900 text-white">
        <div className="container">
          <div className="max-w-2xl mx-auto text-center">
            <h2 className="text-4xl font-serif font-bold mb-4">Join Our Wellness Community</h2>
