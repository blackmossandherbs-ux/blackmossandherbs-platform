...
async function main() {
    ...
    const products = [
        ...
        },
        {
            ...
            images: ['/images/sea_moss_purple.png'],
            category: 'Sea Moss & Seaweed',
        ...
        },
        {
            ...
            price: 19.99,
            images: ['/images/bladderwrack.png'],
            category: 'Sea Moss & Seaweed',
        ...
        },
        {
            ...
            price: 24.99,
            images: ['/images/seamoss_capsules.png'],
            category: 'Sea Moss & Seaweed',
        ...
        // ALKALINE HERBS (Dr. Sebi's List)
        {
            ...
            price: 21.99,
            images: ['/images/sarsaparilla.png'],
        ...
        },
        {
            ...
            price: 14.99,
            images: ['/images/dandelion_root.png'],
            category: 'Alkaline Herbs',
        ...
        },
        {
            ...
            price: 16.99,
            images: ['/images/cascara_sagrada.png'],
            category: 'Alkaline Herbs',
        ...
        },
        {
            ...
            price: 17.99,
            images: ['/images/blue_vervain.png'],
            category: 'Alkaline Herbs',
